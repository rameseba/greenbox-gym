// --- Constantes del Proyecto GreenBox Gym ---

export const PRIMARY_GREEN = '#22c55e';
export const WHATSAPP_NUMBER = '+584122753272'; 
export const WHATSAPP_MESSAGE = encodeURIComponent('Hi! GreenBox VE - Quiero informacion sobre la Prueba Gratis de 2 dias que vi en su pagina Web, me interesa!');
export const INSTAGRAM_HANDLE = 'greenbox_ve';
export const EMAIL_CONTACT = 'greenboxvenezuela@gmail.com';
export const LOCATION_VALENCIA = 'Naguanagua, Valencia';
export const ADDRESS_FULL = 'Av. Bernardino López c/ calle Salom, Naguanagua';
export const MAP_LINK = 'https://maps.app.goo.gl/UovqNDRJdZoLLYax9';
export const SLOGAN = "Tu box verde 💚";
export const MISSION = "Salud física, fortaleza mental y comunidad.";

export const HERO_IMAGE = "/4.jpg";
export const GRID_IMAGE = "/3.jpg";
...
export const SCHEDULE_IMAGE_URL = "/horarios.png";
