...
export const RotatingTestimonial = ({ items, isDark, name, role }: { items: string[], isDark: boolean, name: string, role: string }) => {
  ...
  return (
    <div className={`p-8 md:p-10 rounded-4xl border-2 ${isDark ? 'border-white/5 bg-zinc-900/30' : 'border-black/5 bg-neutral-50'} relative min-h-[220px] md:min-h-[280px] flex flex-col justify-between transition-all duration-500`}>
